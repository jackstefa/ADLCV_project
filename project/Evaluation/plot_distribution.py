...
counts = [516, 819, 291, 161, 142, 119]
...
plt.title('Fitzpatrick Skin Type Distribution (Total: 2048 Images)', fontsize=14)
...
plt.savefig('ISIC_Fitzpatrick_Distribution_2048.png', dpi=300)