...
# Make the secondary y-axis start at 0 and go to 100%
ax2.set_ylim(0, 100)
...
plt.title('Generalization vs Memorization Timescales on ISIC, Unconditioned, Unbalanced, SGD', fontsize=16)
plt.tight_layout()

# Save the plot
output_dir = '../../Saves/final_models/Plots'
os.makedirs(output_dir, exist_ok=True)
output_filename = 'Phase_Diagram_Unconditioned_Unbalanced_SGD.png'
