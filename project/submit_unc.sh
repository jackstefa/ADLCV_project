...
N_SIZE=2048
BATCH_SIZE=512 #For N_SIZE=256, we use a batch size of 256. For N_SIZE>=512, we use a batch size of 512.

cd /zhome/43/8/213582/ACV/project/Training
python run_Unet.py -n $N_SIZE -i 0 -s 32 -LR 0.0001 -O Adam -W 32 -t -1
